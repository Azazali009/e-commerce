...
const FeatureProduct = () => {
  ...
  return (
    <section className=" grid grid-cols-3 justify-center gap-2 gap-x-1 gap-y-7 px-1 py-12 sm:gap-x-5 sm:px-0 md:grid-cols-[repeat(auto-fit,minmax(10rem,1fr))] lg:grid-cols-[repeat(auto-fit,minmax(15rem,1fr))]">
      <div className="mb-8 text-center [grid-column:1/-1]">
        <p className="text-center text-xs text-green-500 sm:text-base">
          check now
        </p>
        <h1 className="  text-xs font-light sm:text-3xl ">
